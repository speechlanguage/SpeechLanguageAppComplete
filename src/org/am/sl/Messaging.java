...
public class Messaging extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		setTitle(getString(R.string.messagingwith) + " "+friend.userName);
	...
	//	friendUserName.setText(friend.userName);
		...
		dbCursor = localstoragehandler.get(friend.userName, IService.USERNAME );
	...
	protected void onResume() {		
		super.onResume();
		bindService(new Intent(Messaging.this, IService.class), mConnection , Context.BIND_AUTO_CREATE);
				
		IntentFilter i = new IntentFilter();
		i.addAction(IService.TAKE_MESSAGE);
